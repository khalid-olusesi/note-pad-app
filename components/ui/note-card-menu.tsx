  ...
  return (
    <>
      ...
      <Dialog open={tagDialogOpen} onOpenChange={setTagDialogOpen}>
        <DialogContent className="inset-auto top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] sm:w-full max-w-sm sm:max-w-sm h-auto max-h-[calc(100%-2rem)] rounded-2xl">
          <DialogHeader>
